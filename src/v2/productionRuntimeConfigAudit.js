...
const REQUIRED_CUTOVER_SUBSTITUTIONS = Object.freeze([
  ...
  "_DONBEOLJA_V2_EXIT_RUNTIME_CANARY_USE_READ_MODEL_LATEST",
  "_DONBEOLJA_V2_EXIT_RUNTIME_CANARY_READ_MODEL_LATEST_LIMIT",
  ...
  "_DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED",
  "_DONBEOLJA_V2_OPENCLAW_POLICY_AUTO_APPLY_ENABLED",
]);
...
const REQUIRED_CUTOVER_ENV = Object.freeze({
  ...
  DONBEOLJA_V2_EXIT_RUNTIME_CANARY_USE_READ_MODEL_LATEST: "$_DONBEOLJA_V2_EXIT_RUNTIME_CANARY_USE_READ_MODEL_LATEST",
  DONBEOLJA_V2_EXIT_RUNTIME_CANARY_READ_MODEL_LATEST_LIMIT: "$_DONBEOLJA_V2_EXIT_RUNTIME_CANARY_READ_MODEL_LATEST_LIMIT",
  ...
  DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED: "$_DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED",
  DONBEOLJA_V2_OPENCLAW_POLICY_AUTO_APPLY_ENABLED: "$_DONBEOLJA_V2_OPENCLAW_POLICY_AUTO_APPLY_ENABLED",
