...
function buildCanonicalEvidenceSummary({
  ...
  return Object.freeze({
    ...
    ml_ai_signal_proposal: Object.freeze(mlAiSignalProposal ? {
      ...
      regime_cohort: mlAiSignalProposal.regime_cohort || null,
      edge_cohort: mlAiSignalProposal.edge_cohort || null,
      tp1_reach_probability: mlAiSignalProposal.tp1_reach_probability ?? null,
      stop_hit_probability: mlAiSignalProposal.stop_hit_probability ?? null,
    } : {
      present: false,
      proposal_id: null,
      ...
      regime_cohort: null,
      edge_cohort: null,
      tp1_reach_probability: null,
      stop_hit_probability: null,
    }),
