    ...
    for (const row of [...signals, ...drops]) {
      ...
      if (!prev) {
        mergedBySignal.set(key, {
          ...
          signal_reason_family: row.kind === "SIGNAL" ? row.reason_family : null,
          ...
          drop_reason_family: row.kind === "DROP" ? row.reason_family : null,
      ...
      mergedBySignal.set(key, {
        ...
        reason_family: coalesce(dropRow && dropRow.reason_family, signalRow && signalRow.reason_family, prev.reason_family, row.reason_family),
        ...
        signal_reason_family: coalesce(prev.signal_reason_family, signalRow && signalRow.reason_family),
        ...
        drop_reason_family: coalesce(prev.drop_reason_family, dropRow && dropRow.reason_family),
