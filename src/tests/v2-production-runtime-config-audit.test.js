...
(function workspaceContractPasses() {
  ...
  // 2026-04-29 — universe expanded 8 → 16 (added WLD, TAO, ARB, INJ,
  // SUI, AAVE, SAND, TIA for BTC-decoupled coverage). The audit pin
  // moves with cloudbuild.yaml.
  assert.strictEqual(
    result.substitutions._DONBEOLJA_V2_DISCOVERY_CANARY_SYMBOLS,
    "BTCUSDT|ETHUSDT|BNBUSDT|XRPUSDT|SOLUSDT|AXSUSDT|DOGEUSDT|LINKUSDT|WLDUSDT|TAOUSDT|ARBUSDT|INJUSDT|SUIUSDT|AAVEUSDT|SANDUSDT|TIAUSDT"
  );
