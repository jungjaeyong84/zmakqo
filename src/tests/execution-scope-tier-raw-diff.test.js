    ...
    rows: [
      {
        ...
        features: { reason: "IN_POSITION_SAME_DIR", action: "ADD", pos_state: "SHORT", pro_conflict: false, score_bucket: "<-60", policy_block_hint: "NONE" },
      },
      {
        row_id: "r2",
        ...
        features: { reason: "IN_POSITION_SAME_DIR", action: "ADD", pos_state: "SHORT", pro_conflict: true, score_bucket: "<-60", policy_block_hint: "NONE" },
      },
      {
        row_id: "r3",
        ...
        features: { reason: "RISK_BUDGET_DISABLED", action: "ENTRY", pos_state: "SHORT", pro_conflict: false, score_bucket: "-20-0", policy_block_hint: "RISK_BUDGET_DISABLED" },
      },
    ],
  },
