...
function buildOpenClawSupremeSummaryFixture({ artifactDir }) {
  return {
    ...
    collector_execution_summary: {
      ...
      openclaw_decision_bundle_ids: ["OCDBV2__LIVE__EVIDENCE__01"],
      openclaw_decision_bundle_hashes: ["decision-bundle-hash-fixture"],
      openclaw_execution_permit_ids: ["OCEPV2__LIVE__EVIDENCE__01"],
      openclaw_outcome_adjudication_ids: ["OCOAV2__LIVE__EVIDENCE__01"],
    ...
    lineage_consistency_summary: {
      ...
      expected_openclaw_decision_bundle_ids: ["OCDBV2__LIVE__EVIDENCE__01"],
      expected_openclaw_execution_permit_ids: ["OCEPV2__LIVE__EVIDENCE__01"],
      expected_openclaw_outcome_adjudication_ids: ["OCOAV2__LIVE__EVIDENCE__01"],
