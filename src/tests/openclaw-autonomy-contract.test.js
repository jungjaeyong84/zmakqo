...
(() => {
  const report = deriveOpenClawAutonomyContract({
    ...
    serverSignalRuntime: { summary: { runtime_status: "READY", exec_tf: "15m", market_count: 7, ev_gate_unknown_gen_relax_enabled: true, ev_gate_unknown_gen_relax_mode: "REPORT_ONLY", ev_gate_unknown_gen_relax_started_at: "2026-04-06T22:50:11.452Z", ev_gate_unknown_gen_relax_window_hours: 6, ev_gate_unknown_gen_relax_review_after_hours: 4, ev_gate_unknown_gen_relax_active_window: true, ev_gate_unknown_gen_relax_auto_rollback_enabled: false, ev_gate_unknown_gen_relax_tp1_prob_min_delta: 0.04, ev_gate_unknown_gen_relax_tp1_prob_full_delta: 0.03, ev_gate_unknown_gen_relax_tp1_prob_kill_delta: 0.02, tp1_ladder_enabled: true, tp1_ladder_freeze: true, tp1_ladder_stage1_realized_n_min: 12, tp1_ladder_stage1_tp0_hit_rate_min: 0.60, tp1_ladder_stage1_tp0_to_tp1_conversion_min: 0.28, tp1_ladder_stage1_fee_adjusted_expectancy_min: 0, tp1_ladder_stage2_realized_n_min: 24, tp1_ladder_stage2_tp0_hit_rate_min: 0.68, tp1_ladder_stage2_tp1_hit_rate_min: 0.38, tp1_ladder_stage2_tp0_to_tp1_conversion_min: 0.45, tp1_ladder_stage2_fee_adjusted_expectancy_min: 0.001, tp1_ladder_default_profile: "RESCUE", tp1_ladder_promotion_mode: "RESCUE_FIRST_FROZEN", signal_overlap_enabled: true, signal_overlap_bars: 4, same_direction_trail_profit_cooldown_enabled: true, same_direction_trail_profit_cooldown_ms: 21600000, opposite_cooldown_bars_base: 4, opposite_cooldown_bars_mixed: 4, opposite_cooldown_bars_rescue: 4, opposite_cooldown_ms_base: 900000, opposite_cooldown_ms_mixed: 3600000, opposite_cooldown_ms_rescue: 3600000, opposite_cooldown_default_profile: "RESCUE", opposite_cooldown_promotion_mode: "RESCUE_FIRST_FROZEN", opposite_transition_enabled: false, opposite_transition_reduce_fraction: 0, opposite_transition_confirm_bars: 4, reverse_exception_mixed_bypass_tier_block: true, reverse_exception_rescue_bypass_tier_block: true, operational_drop_watch_reasons: ["POSITION_FULL", "LIVE_RESCUE_ADD_*", "DROP_OVERLAP"], binance_live_state_self_heal_enabled: true, binance_live_state_self_heal_max_positions: 12, binance_live_state_projection_ssot: "EXCHANGE_LIVE_STATE", binance_live_state_projection_writer_mode: "RECONCILE_FIRST", binance_live_state_active_position_n: 2, binance_live_state_projection_out_of_sync_n: 1, binance_live_state_self_heal_required_n: 1, binance_live_state_native_stop_missing_n: 0, binance_live_state_trail_without_tp1_n: 0, binance_live_state_tp1_done_with_tp_order_n: 1, binance_live_state_invariant_counts: { TP1_DONE_WITH_TP_ORDER: 1 } } },
  ...
  assert.strictEqual(report.current_status.server_signal_runtime_tp1_ladder_freeze, true);
  assert.strictEqual(report.current_status.server_signal_runtime_tp1_ladder_promotion_mode, "RESCUE_FIRST_FROZEN");
  ...
  assert.strictEqual(report.current_status.server_signal_runtime_signal_overlap_bars, 4);
  assert.strictEqual(report.current_status.server_signal_runtime_same_direction_trail_profit_cooldown_enabled, true);
  assert.strictEqual(report.current_status.server_signal_runtime_same_direction_trail_profit_cooldown_ms, 21600000);
  ...
  assert.strictEqual(report.current_status.server_signal_runtime_opposite_cooldown_bars_mixed, 4);
  assert.strictEqual(report.current_status.server_signal_runtime_opposite_cooldown_bars_rescue, 4);
  assert.strictEqual(report.current_status.server_signal_runtime_opposite_cooldown_default_profile, "RESCUE");
  assert.strictEqual(report.current_status.server_signal_runtime_opposite_cooldown_promotion_mode, "RESCUE_FIRST_FROZEN");
  assert.strictEqual(report.current_status.server_signal_runtime_opposite_transition_enabled, false);
  assert.strictEqual(report.current_status.server_signal_runtime_opposite_transition_reduce_fraction, 0);
  assert.strictEqual(report.current_status.server_signal_runtime_opposite_transition_confirm_bars, 4);
  ...
  assert.strictEqual(report.current_status.server_signal_runtime_binance_live_state_self_heal_enabled, true);
  assert.strictEqual(report.current_status.server_signal_runtime_binance_live_state_projection_ssot, "EXCHANGE_LIVE_STATE");
  assert.strictEqual(report.current_status.server_signal_runtime_binance_live_state_projection_writer_mode, "RECONCILE_FIRST");
  assert.strictEqual(report.current_status.server_signal_runtime_binance_live_state_projection_out_of_sync_n, 1);
  assert.strictEqual(report.current_status.server_signal_runtime_binance_live_state_self_heal_required_n, 1);
  assert.deepStrictEqual(report.current_status.server_signal_runtime_binance_live_state_invariant_counts, { TP1_DONE_WITH_TP_ORDER: 1 });
  ...
  assert.strictEqual(report.summary.server_signal_runtime_tp1_ladder_freeze, true);
  assert.strictEqual(report.summary.server_signal_runtime_tp1_ladder_promotion_mode, "RESCUE_FIRST_FROZEN");
  ...
  assert.strictEqual(report.summary.server_signal_runtime_signal_overlap_bars, 4);
  assert.strictEqual(report.summary.server_signal_runtime_same_direction_trail_profit_cooldown_enabled, true);
  assert.strictEqual(report.summary.server_signal_runtime_same_direction_trail_profit_cooldown_ms, 21600000);
  ...
  assert.strictEqual(report.summary.server_signal_runtime_opposite_cooldown_ms_mixed, 3600000);
  assert.strictEqual(report.summary.server_signal_runtime_opposite_cooldown_default_profile, "RESCUE");
  assert.strictEqual(report.summary.server_signal_runtime_opposite_cooldown_promotion_mode, "RESCUE_FIRST_FROZEN");
  assert.strictEqual(report.summary.server_signal_runtime_opposite_transition_enabled, false);
  assert.strictEqual(report.summary.server_signal_runtime_opposite_transition_reduce_fraction, 0);
  assert.strictEqual(report.summary.server_signal_runtime_opposite_transition_confirm_bars, 4);
  ...
  assert.strictEqual(report.summary.server_signal_runtime_binance_live_state_self_heal_enabled, true);
  assert.strictEqual(report.summary.server_signal_runtime_binance_live_state_active_position_n, 2);
  assert.strictEqual(report.summary.server_signal_runtime_binance_live_state_tp1_done_with_tp_order_n, 1);
  assert.deepStrictEqual(report.summary.server_signal_runtime_binance_live_state_invariant_counts, { TP1_DONE_WITH_TP_ORDER: 1 });
