        ...
        console.log(JSON.stringify({
          ...
          diagnostics: v2GenResult && v2GenResult.diagnostics
            ? {
              ...
              bull_close: v2GenResult.diagnostics.bull_close,
              bear_close: v2GenResult.diagnostics.bear_close,
              close_pos_in_bar: v2GenResult.diagnostics.close_pos_in_bar,
              price_position: v2GenResult.diagnostics.price_position,
              long_core_raw: v2GenResult.diagnostics.long_core_raw,
              long_early_raw: v2GenResult.diagnostics.long_early_raw,
              short_core_raw: v2GenResult.diagnostics.short_core_raw,
              short_early_raw: v2GenResult.diagnostics.short_early_raw,
            }
            : null,
        }));
      } catch (_) { /* observability only */ }
