...
async function upsertIntent({
  ...
  const committedResult = await db.runTransaction(async (tx) => {
    ...
    const payload = {
      ...
      live_submit_state: null,
      live_submit_mode: null,
      live_submit_started_at_ms: null,
      live_submit_finished_at_ms: null,
      live_submit_ack_at_ms: null,
      live_submit_order_id: null,
      live_submit_client_order_id: null,
      live_submit_exception_family: null,
      live_submit_error: null,
      live_submit_exec_price: null,
      live_submit_exec_qty_base: null,
