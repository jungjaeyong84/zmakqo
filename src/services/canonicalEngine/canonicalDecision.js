...
function evaluateCanonicalDecision({ features, event, side, market, tf, config, pineShadowDecision = "PASS" } = {}) {
  ...
  const detail = {
    ...
    canonical_engine_transition_core_quality_observed: classification.transition_core_quality_observed === true,
    canonical_engine_transition_core_quality_pass: classification.transition_core_quality_pass === true,
