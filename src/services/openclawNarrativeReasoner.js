...
async function reasonAboutSignal(input = {}, { timeoutMs = DEFAULT_TIMEOUT_MS } = {}) {
  ...
  // Phase C will plug the real LLM call here with resolveTimeoutMs(timeoutMs).
  // Today we keep the module loadable and return a deterministic stub so the
  // evidence-writing wiring can be exercised offline.
