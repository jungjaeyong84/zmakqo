...
function summarizeExecutionQuality({
  ...
  return {
    summary: {
      ...
      execution_scope_tier_weaker_tier_by_mismatch: String(executionScopeTierSummary.weaker_tier_by_mismatch || "").trim() || null,
      execution_scope_tier_weaker_tier_by_macro_recall: String(executionScopeTierSummary.weaker_tier_by_macro_recall || "").trim() || null,
      ...
      execution_scope_tier_early_weakness_score: toNum(executionScopeTierSummary.weakness_scores && executionScopeTierSummary.weakness_scores.EARLY),
      execution_scope_tier_core_weakness_score: toNum(executionScopeTierSummary.weakness_scores && executionScopeTierSummary.weakness_scores.CORE),
