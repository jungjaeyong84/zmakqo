...
function buildMlTrainingRow(row = {}) {
  ...
  return {
    ...
    lifecycle: {
      ...
      tp0_to_tp1_converted: row.tp0_to_tp1_converted === true,
      ...
      pre_tp1_time_stop: row.pre_tp1_time_stop === true,
      time_to_tp0_minutes: toNum(row.time_to_tp0_minutes),
      time_to_tp1_minutes: toNum(row.time_to_tp1_minutes),
      mfe_pct: toNum(row.mfe_pct),
      mae_pct: toNum(row.mae_pct),
    },
    labels,
    features,
  };
