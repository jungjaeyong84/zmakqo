...
function buildMlGlobalCanaryEvidence({
  ...
  return {
    ...
    replay_best_candidate_id: norm(replay.best_candidate_id),
    replay_best_display_candidate_id: norm(replay.best_display_candidate_id),
    replay_best_canonical_candidate_id: norm(replay.best_canonical_candidate_id),
    replay_best_candidate_review_mode: norm(replay.best_candidate_review_mode),
    replay_best_candidate_profile_target_n: toNum(replay.best_candidate_profile_target_n),
    replay_best_candidate_top_return_drag_profile: norm(replay.best_candidate_top_return_drag_profile),
    replay_best_candidate_top_return_drag_driver: norm(replay.best_candidate_top_return_drag_driver),
    replay_best_candidate_top_mixed_profile: norm(replay.best_candidate_top_mixed_profile),
    replay_best_candidate_top_mixed_driver: norm(replay.best_candidate_top_mixed_driver),
