...
function buildReasoningJournal({
  ...
  const autonomyField = (key) => (
    autonomyCurrentStatus[key] != null
      ? autonomyCurrentStatus[key]
      : autonomySummary[key]
  );
  const qualitySummary = readSummary(quality);
  const cutoverSummary = readSummary(cutover);
  ...
  const currentEntry = {
    ...
    current_snapshot: {
      ...
      server_signal_runtime_ev_gate_unknown_gen_relax_enabled: autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_enabled") === true,
      server_signal_runtime_ev_gate_unknown_gen_relax_mode: String(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_mode") || "").trim() || null,
      server_signal_runtime_ev_gate_unknown_gen_relax_started_at: String(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_started_at") || "").trim() || null,
      server_signal_runtime_ev_gate_unknown_gen_relax_window_hours: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_window_hours")),
      server_signal_runtime_ev_gate_unknown_gen_relax_review_after_hours: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_review_after_hours")),
      server_signal_runtime_ev_gate_unknown_gen_relax_active_window: autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_active_window") === true,
      server_signal_runtime_ev_gate_unknown_gen_relax_auto_rollback_enabled: autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_auto_rollback_enabled") === true,
      server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_min_delta: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_min_delta")),
      server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_full_delta: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_full_delta")),
      server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_kill_delta: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_kill_delta")),
      server_signal_runtime_tp1_ladder_enabled: autonomyField("server_signal_runtime_tp1_ladder_enabled") === true,
      server_signal_runtime_tp1_ladder_stage1_realized_n_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_realized_n_min")),
      server_signal_runtime_tp1_ladder_stage1_tp0_hit_rate_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_tp0_hit_rate_min")),
      server_signal_runtime_tp1_ladder_stage1_tp0_to_tp1_conversion_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_tp0_to_tp1_conversion_min")),
      server_signal_runtime_tp1_ladder_stage1_fee_adjusted_expectancy_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_fee_adjusted_expectancy_min")),
      server_signal_runtime_tp1_ladder_stage2_realized_n_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage2_realized_n_min")),
      server_signal_runtime_tp1_ladder_stage2_tp0_hit_rate_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage2_tp0_hit_rate_min")),
      ...
      exit_trailing_contract_active_binance_profile_mode: String(autonomyField("exit_trailing_contract_active_binance_profile_mode") || "").trim() || null,
      exit_trailing_contract_active_binance_tp1_pct: toNum(autonomyField("exit_trailing_contract_active_binance_tp1_pct")),
      exit_trailing_contract_active_binance_be_pct: toNum(autonomyField("exit_trailing_contract_active_binance_be_pct")),
      exit_trailing_contract_active_binance_trail_r_multiple: toNum(autonomyField("exit_trailing_contract_active_binance_trail_r_multiple")),
      runtime_vs_canonical_exit_contract_diverged: autonomyField("runtime_vs_canonical_exit_contract_diverged") === true,
      server_signal_runtime_opposite_cooldown_bars_base: toNum(autonomyField("server_signal_runtime_opposite_cooldown_bars_base")),
      server_signal_runtime_opposite_cooldown_bars_mixed: toNum(autonomyField("server_signal_runtime_opposite_cooldown_bars_mixed")),
      server_signal_runtime_opposite_cooldown_bars_rescue: toNum(autonomyField("server_signal_runtime_opposite_cooldown_bars_rescue")),
      server_signal_runtime_opposite_cooldown_ms_base: toNum(autonomyField("server_signal_runtime_opposite_cooldown_ms_base")),
      server_signal_runtime_opposite_cooldown_ms_mixed: toNum(autonomyField("server_signal_runtime_opposite_cooldown_ms_mixed")),
      server_signal_runtime_opposite_cooldown_ms_rescue: toNum(autonomyField("server_signal_runtime_opposite_cooldown_ms_rescue")),
      server_signal_runtime_opposite_cooldown_default_profile: String(autonomyField("server_signal_runtime_opposite_cooldown_default_profile") || "").trim() || null,
      ...
      filter_layer_2_entry_quality_candidate_verdict: String(autonomyField("filter_layer_2_entry_quality_candidate_verdict") || "").trim() || null,
      filter_layer_2_entry_quality_actions: toNum(autonomyField("filter_layer_2_entry_quality_actions")),
      filter_layer_3_state_soft_sizing_ml_action: String(autonomyField("filter_layer_3_state_soft_sizing_ml_action") || "").trim() || null,
      filter_layer_3_state_soft_sizing_physics_action: String(autonomyField("filter_layer_3_state_soft_sizing_physics_action") || "").trim() || null,
      filter_layer_3_state_soft_sizing_qty_scale: toNum(autonomyField("filter_layer_3_state_soft_sizing_qty_scale")),
      filter_layer_3_state_soft_sizing_dominant_state: String(autonomyField("filter_layer_3_state_soft_sizing_dominant_state") || "").trim() || null,
      filter_layer_3_state_soft_sizing_dominant_action: String(autonomyField("filter_layer_3_state_soft_sizing_dominant_action") || "").trim() || null,
      filter_layer_4_ev_time_value_tuner_reason: String(autonomyField("filter_layer_4_ev_time_value_tuner_reason") || "").trim() || null,
      filter_layer_4_ev_time_value_observed_tuner_reason: String(autonomyField("filter_layer_4_ev_time_value_observed_tuner_reason") || "").trim() || null,
      filter_layer_4_ev_time_value_fresh: autonomyField("filter_layer_4_ev_time_value_fresh") === true,
      filter_layer_4_ev_time_value_age_hours: toNum(autonomyField("filter_layer_4_ev_time_value_age_hours")),
      filter_layer_4_ev_time_value_policy_version: String(autonomyField("filter_layer_4_ev_time_value_policy_version") || "").trim() || null,
      filter_layer_4_ev_time_value_policy_source: String(autonomyField("filter_layer_4_ev_time_value_policy_source") || "").trim() || null,
      filter_layer_5_wait_timing_tuner_reason: String(autonomyField("filter_layer_5_wait_timing_tuner_reason") || "").trim() || null,
      filter_layer_5_wait_timing_wait_action: String(autonomyField("filter_layer_5_wait_timing_wait_action") || "").trim() || null,
      filter_layer_5_wait_timing_febt_calc_ok_rate: toNum(autonomyField("filter_layer_5_wait_timing_febt_calc_ok_rate")),
      filter_layer_5_wait_timing_febt_phase_known: toNum(autonomyField("filter_layer_5_wait_timing_febt_phase_known")),
      filter_layer_5_wait_timing_febt_fire_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_fire_n")),
      filter_layer_5_wait_timing_febt_late_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_late_n")),
      filter_layer_5_wait_timing_febt_void_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_void_n")),
      filter_layer_5_wait_timing_febt_disagreement_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_disagreement_n")),
      filter_layer_5_wait_timing_febt_fallback_legacy_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_fallback_legacy_n")),
      filter_layer_5_wait_timing_febt_missing_rate: toNum(autonomyField("filter_layer_5_wait_timing_febt_missing_rate")),
  ...
  return {
    summary: {
      ...
      current_server_signal_runtime_ev_gate_unknown_gen_relax_enabled: autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_enabled") === true,
      current_server_signal_runtime_ev_gate_unknown_gen_relax_mode: String(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_mode") || "").trim() || null,
      current_server_signal_runtime_ev_gate_unknown_gen_relax_started_at: String(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_started_at") || "").trim() || null,
      current_server_signal_runtime_ev_gate_unknown_gen_relax_window_hours: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_window_hours")),
      current_server_signal_runtime_ev_gate_unknown_gen_relax_review_after_hours: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_review_after_hours")),
      current_server_signal_runtime_ev_gate_unknown_gen_relax_active_window: autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_active_window") === true,
      current_server_signal_runtime_ev_gate_unknown_gen_relax_auto_rollback_enabled: autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_auto_rollback_enabled") === true,
      current_server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_min_delta: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_min_delta")),
      current_server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_full_delta: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_full_delta")),
      current_server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_kill_delta: toNum(autonomyField("server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_kill_delta")),
      current_server_signal_runtime_tp1_ladder_enabled: autonomyField("server_signal_runtime_tp1_ladder_enabled") === true,
      current_server_signal_runtime_tp1_ladder_stage1_realized_n_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_realized_n_min")),
      current_server_signal_runtime_tp1_ladder_stage1_tp0_hit_rate_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_tp0_hit_rate_min")),
      current_server_signal_runtime_tp1_ladder_stage1_tp0_to_tp1_conversion_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_tp0_to_tp1_conversion_min")),
      current_server_signal_runtime_tp1_ladder_stage1_fee_adjusted_expectancy_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage1_fee_adjusted_expectancy_min")),
      current_server_signal_runtime_tp1_ladder_stage2_realized_n_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage2_realized_n_min")),
      current_server_signal_runtime_tp1_ladder_stage2_tp0_hit_rate_min: toNum(autonomyField("server_signal_runtime_tp1_ladder_stage2_tp0_hit_rate_min")),
      ...
      current_exit_trailing_contract_active_binance_be_pct: toNum(autonomyField("exit_trailing_contract_active_binance_be_pct")),
      current_exit_trailing_contract_active_binance_trail_r_multiple: toNum(autonomyField("exit_trailing_contract_active_binance_trail_r_multiple")),
      current_runtime_vs_canonical_exit_contract_diverged: autonomyField("runtime_vs_canonical_exit_contract_diverged") === true,
      current_server_signal_runtime_opposite_cooldown_bars_base: toNum(autonomyField("server_signal_runtime_opposite_cooldown_bars_base")),
      current_server_signal_runtime_opposite_cooldown_bars_mixed: toNum(autonomyField("server_signal_runtime_opposite_cooldown_bars_mixed")),
      current_server_signal_runtime_opposite_cooldown_bars_rescue: toNum(autonomyField("server_signal_runtime_opposite_cooldown_bars_rescue")),
      current_server_signal_runtime_opposite_cooldown_ms_base: toNum(autonomyField("server_signal_runtime_opposite_cooldown_ms_base")),
      current_server_signal_runtime_opposite_cooldown_ms_mixed: toNum(autonomyField("server_signal_runtime_opposite_cooldown_ms_mixed")),
      ...
      current_filter_layer_1_integrity_expectation: String(autonomyField("filter_layer_1_integrity_expectation") || "").trim() || null,
      current_filter_layer_1_integrity_coverage_pass: autonomyField("filter_layer_1_integrity_coverage_pass") === true,
      current_filter_layer_2_entry_quality_candidate_verdict: String(autonomyField("filter_layer_2_entry_quality_candidate_verdict") || "").trim() || null,
      current_filter_layer_2_entry_quality_actions: toNum(autonomyField("filter_layer_2_entry_quality_actions")),
      current_filter_layer_3_state_soft_sizing_ml_action: String(autonomyField("filter_layer_3_state_soft_sizing_ml_action") || "").trim() || null,
      current_filter_layer_3_state_soft_sizing_physics_action: String(autonomyField("filter_layer_3_state_soft_sizing_physics_action") || "").trim() || null,
      current_filter_layer_3_state_soft_sizing_qty_scale: toNum(autonomyField("filter_layer_3_state_soft_sizing_qty_scale")),
      current_filter_layer_3_state_soft_sizing_dominant_state: String(autonomyField("filter_layer_3_state_soft_sizing_dominant_state") || "").trim() || null,
      current_filter_layer_3_state_soft_sizing_dominant_action: String(autonomyField("filter_layer_3_state_soft_sizing_dominant_action") || "").trim() || null,
      current_filter_layer_4_ev_time_value_tuner_reason: String(autonomyField("filter_layer_4_ev_time_value_tuner_reason") || "").trim() || null,
      current_filter_layer_4_ev_time_value_observed_tuner_reason: String(autonomyField("filter_layer_4_ev_time_value_observed_tuner_reason") || "").trim() || null,
      current_filter_layer_4_ev_time_value_fresh: autonomyField("filter_layer_4_ev_time_value_fresh") === true,
      current_filter_layer_4_ev_time_value_age_hours: toNum(autonomyField("filter_layer_4_ev_time_value_age_hours")),
      current_filter_layer_4_ev_time_value_policy_version: String(autonomyField("filter_layer_4_ev_time_value_policy_version") || "").trim() || null,
      current_filter_layer_4_ev_time_value_policy_source: String(autonomyField("filter_layer_4_ev_time_value_policy_source") || "").trim() || null,
      current_filter_layer_5_wait_timing_tuner_reason: String(autonomyField("filter_layer_5_wait_timing_tuner_reason") || "").trim() || null,
      current_filter_layer_5_wait_timing_wait_action: String(autonomyField("filter_layer_5_wait_timing_wait_action") || "").trim() || null,
      current_filter_layer_5_wait_timing_febt_calc_ok_rate: toNum(autonomyField("filter_layer_5_wait_timing_febt_calc_ok_rate")),
      current_filter_layer_5_wait_timing_febt_phase_known: toNum(autonomyField("filter_layer_5_wait_timing_febt_phase_known")),
      current_filter_layer_5_wait_timing_febt_fire_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_fire_n")),
      current_filter_layer_5_wait_timing_febt_late_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_late_n")),
      current_filter_layer_5_wait_timing_febt_void_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_void_n")),
      current_filter_layer_5_wait_timing_febt_disagreement_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_disagreement_n")),
      current_filter_layer_5_wait_timing_febt_fallback_legacy_n: toNum(autonomyField("filter_layer_5_wait_timing_febt_fallback_legacy_n")),
      current_filter_layer_5_wait_timing_febt_missing_rate: toNum(autonomyField("filter_layer_5_wait_timing_febt_missing_rate")),
