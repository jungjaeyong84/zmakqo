...
function buildMlExperimentRegistry({
  ...
  return {
    ...
    execution_serving_scope_train_run_aligned: servingContract.scope_train_run_aligned === true,
    execution_serving_scope_registry_aligned: servingContract.scope_registry_aligned === true,
    ...
    ml_promotion_model_specific_canary_gate_status: String(promotionGate.model_specific_canary_gate_status || "").trim().toUpperCase() || null,
    ml_promotion_model_specific_canary_ready: promotionGate.model_specific_canary_ready === true,
