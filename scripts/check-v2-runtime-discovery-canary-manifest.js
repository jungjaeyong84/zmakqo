...
const DEFAULT_DISCOVERY_CANARY_SYMBOLS = "BTCUSDT|ETHUSDT|BNBUSDT|XRPUSDT|SOLUSDT|AXSUSDT|DOGEUSDT|LINKUSDT|WLDUSDT|TAOUSDT|ARBUSDT|INJUSDT|SUIUSDT|AAVEUSDT|SANDUSDT|TIAUSDT";
const DEFAULT_DISCOVERY_CANARY_MAX_SYMBOL_COUNT = "16";
...
function buildExpectedEnv(env = process.env) {
  return Object.freeze({
    ...
    DONBEOLJA_V2_INITIAL_PROTECTION_DEADLINE_ENABLED: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_INITIAL_PROTECTION_DEADLINE_ENABLED",
      "DONBEOLJA_V2_INITIAL_PROTECTION_DEADLINE_ENABLED",
      "1",
    ),
    DONBEOLJA_SIGNAL_DROP_CONSUME_LOCK_ENABLED: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_SIGNAL_DROP_CONSUME_LOCK_ENABLED",
      "DONBEOLJA_SIGNAL_DROP_CONSUME_LOCK_ENABLED",
      "1",
    ),
    DONBEOLJA_V2_REPAIR_WRITER_LEASE_FIRESTORE_ENABLED: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_REPAIR_WRITER_LEASE_FIRESTORE_ENABLED",
      "DONBEOLJA_V2_REPAIR_WRITER_LEASE_FIRESTORE_ENABLED",
      "1",
    ),
    DONBEOLJA_V2_REPAIR_WRITER_LEASE_TTL_MS: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_REPAIR_WRITER_LEASE_TTL_MS",
      "DONBEOLJA_V2_REPAIR_WRITER_LEASE_TTL_MS",
      "60000",
    ),
    DONBEOLJA_V2_REPAIR_WRITER_LEASE_HEARTBEAT_MS: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_REPAIR_WRITER_LEASE_HEARTBEAT_MS",
      "DONBEOLJA_V2_REPAIR_WRITER_LEASE_HEARTBEAT_MS",
      "10000",
    ),
    DONBEOLJA_V2_SHADOW_EXIT_WRITE_ENABLED: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_SHADOW_EXIT_WRITE_ENABLED",
      "DONBEOLJA_V2_SHADOW_EXIT_WRITE_ENABLED",
      "1",
    ),
    DONBEOLJA_V2_SHADOW_ALERT_DELIVERY_ENABLED: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_SHADOW_ALERT_DELIVERY_ENABLED",
      "DONBEOLJA_V2_SHADOW_ALERT_DELIVERY_ENABLED",
      "1",
    ),
    ...
    DONBEOLJA_V2_OPENCLAW_DECISION_GATE_ENABLED: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_OPENCLAW_DECISION_GATE_ENABLED",
      "DONBEOLJA_V2_OPENCLAW_DECISION_GATE_ENABLED",
      "1",
    ),
    DONBEOLJA_V2_OPENCLAW_DECISION_GATE_MODE: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_OPENCLAW_DECISION_GATE_MODE",
      "DONBEOLJA_V2_OPENCLAW_DECISION_GATE_MODE",
      "BLOCK_ONLY",
    ),
    ...
    DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED: expectedValue(
      env,
      "DONBEOLJA_V2_EXPECTED_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED",
      "DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED",
      "0",
    ),
