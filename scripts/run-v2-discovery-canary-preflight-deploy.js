...
function buildDiscoverySubstitutions(env = process.env) {
  return Object.freeze({
    ...
    _DONBEOLJA_V2_DISCOVERY_CANARY_MAX_TRADES_PER_DAY: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_MAX_TRADES_PER_DAY) || "5",
    ...
    _DONBEOLJA_V2_RISK_MAX_TOTAL_NOTIONAL_QUOTE: trimOrNull(env.DONBEOLJA_V2_RISK_MAX_TOTAL_NOTIONAL_QUOTE) || "250",
    _DONBEOLJA_V2_RISK_MAX_SYMBOL_NOTIONAL_QUOTE: trimOrNull(env.DONBEOLJA_V2_RISK_MAX_SYMBOL_NOTIONAL_QUOTE) || "230",
    _DONBEOLJA_V2_RISK_MAX_CORRELATED_GROUP_NOTIONAL_QUOTE: trimOrNull(env.DONBEOLJA_V2_RISK_MAX_CORRELATED_GROUP_NOTIONAL_QUOTE) || "250",
