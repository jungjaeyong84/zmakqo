...
const { CLOUDBUILD_BUDGET_OVERRIDE_PHRASE } = cloudbuildSubmitBudget;
...
function buildDiscoverySubstitutions(env = process.env) {
  return Object.freeze({
    ...
    _DONBEOLJA_V2_DISCOVERY_CANARY_MAX_SYMBOL_COUNT: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_MAX_SYMBOL_COUNT) || "16",
    ...
    _DONBEOLJA_V2_DISCOVERY_CANARY_SYMBOL_NOTIONAL_QUOTE_MAP: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_SYMBOL_NOTIONAL_QUOTE_MAP)
      || DEFAULT_DISCOVERY_CANARY_SYMBOL_NOTIONAL_QUOTE_MAP_TEXT,
    _DONBEOLJA_V2_DISCOVERY_CANARY_MAX_POSITION_COUNT: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_MAX_POSITION_COUNT) || "8",
    ...
    _DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED) || "0",
    _DONBEOLJA_V2_DISCOVERY_CANARY_QUARANTINE_SYMBOLS: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_QUARANTINE_SYMBOLS) || "",
    _DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_LOOKBACK_HOURS: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_LOOKBACK_HOURS) || "72",
    _DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_MIN_TRADES: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_MIN_TRADES) || "4",
    _DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_MIN_WIN_RATE_PCT: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_MIN_WIN_RATE_PCT) || "35",
    _DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_MAX_NET_LOSS_QUOTE: trimOrNull(env.DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_MAX_NET_LOSS_QUOTE) || "2",
    _DONBEOLJA_V2_OPENCLAW_EXECUTION_AUDIT_LEDGER_WRITE_ENABLED: "1",
    _DONBEOLJA_V2_OPENCLAW_DECISION_GATE_ENABLED: trimOrNull(env.DONBEOLJA_V2_OPENCLAW_DECISION_GATE_ENABLED) || "1",
    _DONBEOLJA_V2_OPENCLAW_DECISION_GATE_MODE: trimOrNull(env.DONBEOLJA_V2_OPENCLAW_DECISION_GATE_MODE) || "BLOCK_ONLY",
    _DONBEOLJA_V2_RISK_GOVERNOR_REQUIRED: "1",
    _DONBEOLJA_V2_INITIAL_PROTECTION_DEADLINE_ENABLED: "1",
    _DONBEOLJA_SIGNAL_DROP_CONSUME_LOCK_ENABLED: "1",
    _DONBEOLJA_V2_REPAIR_WRITER_LEASE_FIRESTORE_ENABLED: "1",
    _DONBEOLJA_V2_REPAIR_WRITER_LEASE_TTL_MS: "60000",
    _DONBEOLJA_V2_REPAIR_WRITER_LEASE_HEARTBEAT_MS: "10000",
    ...
    _DONBEOLJA_V2_RISK_MAX_TOTAL_NOTIONAL_QUOTE: trimOrNull(env.DONBEOLJA_V2_RISK_MAX_TOTAL_NOTIONAL_QUOTE) || "1300",
    _DONBEOLJA_V2_RISK_MAX_SYMBOL_NOTIONAL_QUOTE: trimOrNull(env.DONBEOLJA_V2_RISK_MAX_SYMBOL_NOTIONAL_QUOTE) || "200",
    _DONBEOLJA_V2_RISK_MAX_CORRELATED_GROUP_NOTIONAL_QUOTE: trimOrNull(env.DONBEOLJA_V2_RISK_MAX_CORRELATED_GROUP_NOTIONAL_QUOTE) || "900",
...
function buildRuntimeManifestEnv(env = process.env, substitutions = {}) {
  return Object.freeze({
    ...
    DONBEOLJA_V2_EXPECTED_OPENCLAW_DECISION_GATE_ENABLED: substitutions._DONBEOLJA_V2_OPENCLAW_DECISION_GATE_ENABLED,
    DONBEOLJA_V2_EXPECTED_OPENCLAW_DECISION_GATE_MODE: substitutions._DONBEOLJA_V2_OPENCLAW_DECISION_GATE_MODE,
    ...
    DONBEOLJA_V2_EXPECTED_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED: substitutions._DONBEOLJA_V2_DISCOVERY_CANARY_REALIZED_GUARD_ENABLED,
...
async function main(env = process.env, options = {}) {
  ...
  const cloudbuildBudget = cloudbuildSubmitBudget.evaluateCloudBuildSubmitBudget({
    env,
    execFileSyncFn,
...
if (require.main === module) {
  ...
  module.exports = {
    ...
    __test: {
      ...
      toPositiveInt: cloudbuildSubmitBudget.toPositiveInt,
    },
  };
}
