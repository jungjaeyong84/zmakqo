...
const OPENCLAW_CLOUD_SCHEDULER_JOBS = Object.freeze([
  ...
  {
    job_id: "v2_performance_evidence_cycle",
    scheduler_name: "v2-performance-evidence-cycle",
    scheduler_region: "asia-northeast3",
    scheduler_schedule: "10 * * * *",
    scheduler_time_zone: "Asia/Seoul",
    http_path: "/api/openclaw/cron/v2-performance-evidence-cycle",
    owner: "openclaw",
    criticality: "HIGH",
    produces_artifact: "v2_performance_gate_latest.json",
    artifact_sla_hours: 2,
    runtime_mode: "LIVE_PERFORMANCE_EVIDENCE_CYCLE",
    depends_on_scheduler_names: ["v2-fill-sync", "v2-active-protection-reconciliation"],
  },
  {
...
const OPENCLAW_LOCAL_COST_SAVER_JOBS = Object.freeze([
  {
    job_id: "openclaw_server_primary_tick",
    scheduler_name: "openclaw-server-primary-tick",
    label: "com.jeongjaeyong.donbeolja.openclawserverprimarytick",
    wrapper: `${REPO_ROOT}/ops/launchd/run_openclaw_server_primary_tick.sh`,
    start_calendar_interval: [1, 16, 31, 46].map((minute) => ({ minute })),
    runAtLoad: true,
    criticality: "HIGH",
    log_basename: "openclaw_server_primary_tick",
  },
  {
    job_id: "v2_production_entry_route_canary",
    scheduler_name: "v2-production-entry-route-canary",
    label: "com.jeongjaeyong.donbeolja.v2productionentryroutecanary",
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_production_entry_route_canary.sh`,
    start_calendar_interval: [{ minute: 5 }],
    runAtLoad: true,
    criticality: "HIGH",
    log_basename: "v2_production_entry_route_canary",
  },
  {
    job_id: "v2_exit_runtime_canary",
    scheduler_name: "v2-exit-runtime-canary",
    label: "com.jeongjaeyong.donbeolja.v2exitruntimecanary",
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_exit_runtime_canary.sh`,
    start_calendar_interval: [{ minute: 35 }],
    runAtLoad: true,
    criticality: "HIGH",
    log_basename: "v2_exit_runtime_canary",
  },
  {
    job_id: "v2_active_protection_reconciliation",
    scheduler_name: "v2-active-protection-reconciliation",
    label: "com.jeongjaeyong.donbeolja.v2activeprotectionreconciliation",
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_active_protection_reconciliation.sh`,
    start_calendar_interval: [{ minute: 0 }],
    runAtLoad: true,
    criticality: "HIGH",
    log_basename: "v2_active_protection_reconciliation",
  },
  {
    job_id: "v2_fill_sync",
    scheduler_name: "v2-fill-sync",
    label: "com.jeongjaeyong.donbeolja.v2fillsync",
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_fill_sync.sh`,
    start_interval_seconds: 300,
    runAtLoad: true,
    criticality: "HIGH",
    log_basename: "v2_fill_sync",
  },
  {
    job_id: "v2_performance_evidence_cycle",
    scheduler_name: "v2-performance-evidence-cycle",
    label: "com.jeongjaeyong.donbeolja.v2performanceevidencecycle",
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_performance_evidence_cycle.sh`,
    start_calendar_interval: [{ minute: 10 }],
    runAtLoad: true,
    criticality: "HIGH",
  ...
  },
  {
    ...
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_signal_shadow_counterfactual_walker.sh`,
    start_interval_seconds: 900,
    runAtLoad: true,
    criticality: "MEDIUM",
    log_basename: "v2_signal_shadow_counterfactual_walker",
  },
  {
    job_id: "v2_signal_shadow_counterfactual_analyzer",
    scheduler_name: "v2-signal-shadow-counterfactual-analyzer",
    label: "com.jeongjaeyong.donbeolja.v2signalshadowcounterfactualanalyzer",
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_signal_shadow_counterfactual_analyzer.sh`,
    start_calendar_interval: [{ hour: 7, minute: 0 }],
    runAtLoad: false,
    criticality: "MEDIUM",
    log_basename: "v2_signal_shadow_counterfactual_analyzer",
  },
  {
    job_id: "v2_liquidation_stream_collector_window",
    scheduler_name: "v2-liquidation-stream-collector-window",
    label: "com.jeongjaeyong.donbeolja.v2liquidationstreamcollectorwindow",
    wrapper: `${REPO_ROOT}/ops/launchd/run_v2_liquidation_stream_collector_window.sh`,
    start_interval_seconds: 300,
    runAtLoad: true,
    criticality: "MEDIUM",
    log_basename: "v2_liquidation_stream_collector_window",
  },
  {
    job_id: "openclaw_agent_evidence_linker",
    scheduler_name: "openclaw-evidence-linker",
  ...
  },
  {
    ...
    start_calendar_interval: [0, 4, 8, 12, 16, 20].map((hour) => ({ hour, minute: 5 })),
    runAtLoad: true,
    criticality: "HIGH",
    log_basename: "openclaw_calibration",
  },
  {
    job_id: "openclaw_agent_retrospect",
    scheduler_name: "openclaw-retrospect",
    ...
    start_calendar_interval: [{ hour: 6, minute: 30 }],
    runAtLoad: true,
    criticality: "MEDIUM",
    log_basename: "openclaw_retrospect",
  },
]);
