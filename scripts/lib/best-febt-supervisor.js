...
const SELF_EVOLUTION_LOOP_RUN_LATEST_PATH = path.join(OPS_DAILY_DIR, "best_self_evolution_loop_run_latest.json");
...
function buildSelfEvolutionPolicySpec() {
  return {
    ...
    loop_run_latest_path: SELF_EVOLUTION_LOOP_RUN_LATEST_PATH,
    ...
    status: "ACTIVE",
    current_focus: "P0_DATASET,P1_OBJECTIVE,P2_ATTRIBUTION,P3_CANDIDATE_CHANGESET,P4_REPLAY,P5_CANARY,P6_AUTOROLLBACK,P7_MEMORY_LEDGER,CANARY_SCALE,DEPLOYMENT_GUARDS,DEPLOYMENT_HANDOFF,LOOP_MONITORING,LOOP_ORCHESTRATION,CYCLE_ATOMICITY,MEMORY_PREBLOCK,WEIGHT_TUNING_ADVISORY",
