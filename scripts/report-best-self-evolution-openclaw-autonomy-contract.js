...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- ml_promotion_gate: ${status.ml_promotion_gate_status || "N/A"} / ${status.ml_promotion_stage || "N/A"} / ${status.ml_promotion_decision || "N/A"} / canary=${status.ml_promotion_model_specific_canary_gate_status || "N/A"} / binding=${status.ml_promotion_model_specific_canary_binding_mode || "N/A"}`,
