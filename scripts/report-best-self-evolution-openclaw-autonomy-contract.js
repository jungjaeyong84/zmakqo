...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- ml_global_canary: ${status.ml_global_canary_status || "N/A"} / evidence=${status.ml_global_canary_evidence_status || "N/A"} / blocker=${status.ml_global_canary_dominant_blocker || "N/A"} / ready=${status.ml_global_canary_ready ? "YES" : "NO"}`,
    ...
    `- ml_promotion_gate: ${status.ml_promotion_gate_status || "N/A"} / ${status.ml_promotion_stage || "N/A"} / ${status.ml_promotion_decision || "N/A"} / global=${status.ml_promotion_global_canary_gate_status || "N/A"} / canary=${status.ml_promotion_model_specific_canary_gate_status || "N/A"} / rollback=${status.ml_promotion_rollback_gate_status || "N/A"} / binding=${status.ml_promotion_model_specific_canary_binding_mode || "N/A"}`,
