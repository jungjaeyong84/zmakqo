...
const INPUTS = Object.freeze({
  ...
  cohortRegimeParameterSplitContract: path.join(OPS_DAILY_DIR, "best_self_evolution_cohort_regime_parameter_split_contract_latest.json"),
  ...
  validationDeploymentPipelineContract: path.join(OPS_DAILY_DIR, "best_self_evolution_validation_deployment_pipeline_contract_latest.json"),
  performanceKpiUpgradeContract: path.join(OPS_DAILY_DIR, "best_self_evolution_performance_kpi_upgrade_contract_latest.json"),
...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- primary_metrics: ${Array.isArray(report.objective_policy && report.objective_policy.primary_performance_metrics) ? report.objective_policy.primary_performance_metrics.join(", ") : "N/A"}`,
    `- legacy_win_rate_reference_only: ${report.objective_policy && report.objective_policy.legacy_win_rate_reference_only ? "YES" : "NO"}`,
    "",
    "## Authority Policy",
    ...
    "",
    "## Current Status",
    `- objective_score/monthly/legacy_win_ref: ${status.objective_score != null ? status.objective_score : "N/A"} / ${status.monthly_run_rate_krw != null ? status.monthly_run_rate_krw : "N/A"} / ${status.win_rate != null ? status.win_rate : "N/A"}`,
    ...
    `- server_signal_ev_unknown_gen_relax: enabled=${status.server_signal_runtime_ev_gate_unknown_gen_relax_enabled ? "YES" : "NO"} / mode=${status.server_signal_runtime_ev_gate_unknown_gen_relax_mode || "N/A"} / active_window=${status.server_signal_runtime_ev_gate_unknown_gen_relax_active_window ? "YES" : "NO"} / review_after_h=${status.server_signal_runtime_ev_gate_unknown_gen_relax_review_after_hours ?? "N/A"} / window_h=${status.server_signal_runtime_ev_gate_unknown_gen_relax_window_hours ?? "N/A"} / deltas=${status.server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_min_delta ?? "N/A"}/${status.server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_full_delta ?? "N/A"}/${status.server_signal_runtime_ev_gate_unknown_gen_relax_tp1_prob_kill_delta ?? "N/A"}`,
    `- exit_contract_bridge: canonical=${status.exit_trailing_contract_active_binance_profile_mode || "N/A"} / tp1=${status.exit_trailing_contract_active_binance_tp1_pct ?? "N/A"} / be=${status.exit_trailing_contract_active_binance_be_pct ?? "N/A"} / trail_r=${status.exit_trailing_contract_active_binance_trail_r_multiple ?? "N/A"} / runtime_default=${status.server_signal_runtime_tp1_ladder_default_profile || "N/A"} / diverged=${status.runtime_vs_canonical_exit_contract_diverged ? "YES" : "NO"}`,
    `- filter_layers_1_5: 1=${status.filter_layer_1_integrity_mode || "N/A"}:${status.filter_layer_1_integrity_coverage_pass ? "PASS" : "BLOCK"} / 2=${status.filter_layer_2_entry_quality_candidate_verdict || "N/A"}:${status.filter_layer_2_entry_quality_actions ?? "N/A"} / 3=${status.filter_layer_3_state_soft_sizing_ml_action || "N/A"}:${status.filter_layer_3_state_soft_sizing_physics_action || "N/A"}:${status.filter_layer_3_state_soft_sizing_qty_scale ?? "N/A"} / 4=${status.filter_layer_4_ev_time_value_tuner_reason || "N/A"}:${status.filter_layer_4_ev_time_value_policy_version || "N/A"} / 5=${status.filter_layer_5_wait_timing_tuner_reason || "N/A"}:${status.filter_layer_5_wait_timing_wait_action || "N/A"}`,
    `- server_signal_flow_24h: authoritative=${status.server_signal_authoritative_24h_n != null ? status.server_signal_authoritative_24h_n : "N/A"} / shadow=${status.server_signal_shadow_24h_n != null ? status.server_signal_shadow_24h_n : "N/A"} / entry=${status.server_signal_entry_24h_n != null ? status.server_signal_entry_24h_n : "N/A"} / intent=${status.server_signal_intent_24h_n != null ? status.server_signal_intent_24h_n : "N/A"} / fill=${status.server_signal_fill_24h_n != null ? status.server_signal_fill_24h_n : "N/A"} / entry->intent=${status.server_signal_entry_to_intent_conversion_24h != null ? status.server_signal_entry_to_intent_conversion_24h : "N/A"} / signal->fill=${status.server_signal_entry_to_fill_conversion_24h != null ? status.server_signal_entry_to_fill_conversion_24h : "N/A"}`,
    `- server_signal_cost_controls: overlap=${status.server_signal_runtime_signal_overlap_enabled ? "ON" : "OFF"}:${status.server_signal_runtime_signal_overlap_bars ?? "N/A"} / same_dir_trail_cd=${status.server_signal_runtime_same_direction_trail_profit_cooldown_enabled ? "ON" : "OFF"}:${status.server_signal_runtime_same_direction_trail_profit_cooldown_ms ?? "N/A"} / reverse=${status.server_signal_runtime_opposite_transition_enabled ? "ON" : "OFF"}:${status.server_signal_runtime_opposite_transition_reduce_fraction ?? "N/A"}:${status.server_signal_runtime_opposite_transition_confirm_bars ?? "N/A"} / watch=${Array.isArray(status.server_signal_runtime_operational_drop_watch_reasons) && status.server_signal_runtime_operational_drop_watch_reasons.length ? status.server_signal_runtime_operational_drop_watch_reasons.join("|") : "N/A"}`,
    ...
    `- execution_structure_upgrade: ${summary.execution_structure_upgrade_contract_status || "N/A"} / mode=${status.execution_structure_upgrade_mode || "N/A"} / sequence_ready=${status.execution_structure_upgrade_stage_sequence_ready ? "YES" : "NO"} / survivability=${status.execution_structure_upgrade_survivability_ready ? "YES" : "NO"} / labels=${status.execution_structure_upgrade_label_support_ready ? "YES" : "NO"} / tp0=${status.execution_structure_upgrade_tp0_stage_active ? "YES" : "NO"} / tp1=${status.execution_structure_upgrade_tp1_stage_active ? "YES" : "NO"} / trail=${status.execution_structure_upgrade_trail_stage_active ? "YES" : "NO"} / block_n=${status.execution_structure_upgrade_blocking_reason_n ?? "N/A"}`,
    `- cost_control_engine: ${summary.cost_control_engine_contract_status || "N/A"} / mode=${status.cost_control_engine_contract_mode || "N/A"} / entry_suppression=${status.cost_control_engine_automatic_entry_suppression_ready ? "YES" : "NO"} / reentry=${status.cost_control_engine_system_reentry_control_ready ? "YES" : "NO"} / expectancy=${status.cost_control_engine_expectancy_gate_active ? "YES" : "NO"}:${status.cost_control_engine_expectancy_metric || "N/A"} / ops_mode=${status.cost_control_engine_operations_mode || "N/A"} / cooldown=${status.cost_control_engine_cooldown_reentry_control_active ? "YES" : "NO"}:${status.cost_control_engine_cooldown_policy_mismatch_n ?? "N/A"} / reverse=${status.cost_control_engine_reverse_reentry_control_active ? "YES" : "NO"}:${status.cost_control_engine_reverse_blocked_n ?? "N/A"} / block_n=${status.cost_control_engine_blocking_reason_n ?? "N/A"}`,
    `- cohort_regime_parameter_split: ${summary.cohort_regime_parameter_split_contract_status || "N/A"} / mode=${status.cohort_regime_parameter_split_contract_mode || "N/A"} / cohort_scope=${status.cohort_regime_parameter_split_cohort_scope || "N/A"} / cohorts=${status.cohort_regime_parameter_split_active_cohort_n ?? "N/A"} / parameterization=${status.cohort_regime_parameter_split_cohort_parameterization_ready ? "YES" : "NO"} / regime_switch=${status.cohort_regime_parameter_split_regime_switch_ready ? "YES" : "NO"} / policy_scope=${status.cohort_regime_parameter_split_policy_scoped_ready ? "YES" : "NO"} / auto_transition=${status.cohort_regime_parameter_split_automatic_transition_ready ? "YES" : "NO"} / block_n=${status.cohort_regime_parameter_split_blocking_reason_n ?? "N/A"}`,
    ...
    `- validation_deployment_pipeline: ${summary.validation_deployment_pipeline_contract_status || "N/A"} / mode=${status.validation_deployment_pipeline_contract_mode || "N/A"} / stage=${status.validation_deployment_pipeline_current_deployment_stage || "N/A"} / shadow=${status.validation_deployment_pipeline_shadow_numeric_gate_ready ? "YES" : "NO"} / canary=${status.validation_deployment_pipeline_canary_numeric_gate_ready ? "YES" : "NO"} / live=${status.validation_deployment_pipeline_live_numeric_gate_ready ? "YES" : "NO"} / judgement=${status.validation_deployment_pipeline_numeric_judgement_ready ? "YES" : "NO"} / rollback=${status.validation_deployment_pipeline_automatic_rollback_ready ? "YES" : "NO"} / block_n=${status.validation_deployment_pipeline_blocking_reason_n ?? "N/A"}`,
    `- performance_kpi_upgrade: ${summary.performance_kpi_upgrade_contract_status || "N/A"} / mode=${status.performance_kpi_upgrade_contract_mode || "N/A"} / micro=${status.performance_kpi_upgrade_microstructure_kpi_ready ? "YES" : "NO"} / survivability=${status.performance_kpi_upgrade_survivability_kpi_ready ? "YES" : "NO"} / expectancy=${status.performance_kpi_upgrade_expectancy_kpi_ready ? "YES" : "NO"} / structure=${status.performance_kpi_upgrade_structure_alignment_ready ? "YES" : "NO"} / cost=${status.performance_kpi_upgrade_cost_alignment_ready ? "YES" : "NO"} / tp0=${status.performance_kpi_upgrade_tp0_hit_rate ?? "N/A"} / tp1=${status.performance_kpi_upgrade_tp1_hit_rate ?? "N/A"} / conversion=${status.performance_kpi_upgrade_tp0_to_tp1_conversion_rate ?? "N/A"} / expectancy_net=${status.performance_kpi_upgrade_fee_adjusted_expectancy ?? "N/A"} / block_n=${status.performance_kpi_upgrade_blocking_reason_n ?? "N/A"}`,
...
function main() {
  ...
  const report = deriveOpenClawAutonomyContract({
    ...
    cohortRegimeParameterSplitContract: readJsonRawSafe(INPUTS.cohortRegimeParameterSplitContract, null),
    ...
    validationDeploymentPipelineContract: readJsonRawSafe(INPUTS.validationDeploymentPipelineContract, null),
    performanceKpiUpgradeContract: readJsonRawSafe(INPUTS.performanceKpiUpgradeContract, null),
