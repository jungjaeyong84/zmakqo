...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- ml_global_canary: ${status.ml_global_canary_status || "N/A"} / evidence=${status.ml_global_canary_evidence_status || "N/A"} / blocker=${status.ml_global_canary_dominant_blocker || "N/A"} / replay=${status.ml_global_canary_replay_evidence_status || "N/A"}:${status.ml_global_canary_replay_dominant_issue || "N/A"} / sample_gap=${status.ml_global_canary_replay_sample_gap_status || "N/A"}:${status.ml_global_canary_replay_sample_gap_n ?? "N/A"} / ready=${status.ml_global_canary_ready ? "YES" : "NO"}`,
