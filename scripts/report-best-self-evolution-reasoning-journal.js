...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- ml_global_canary: ${summary.current_ml_global_canary_status || "N/A"} / evidence=${summary.current_ml_global_canary_evidence_status || "N/A"} / blocker=${summary.current_ml_global_canary_dominant_blocker || "N/A"} / ready=${summary.current_ml_global_canary_ready ? "YES" : "NO"}`,
