...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- exit_contract_bridge: canonical=${summary.current_exit_trailing_contract_active_binance_profile_mode || "N/A"} / tp1=${summary.current_exit_trailing_contract_active_binance_tp1_pct ?? "N/A"} / be=${summary.current_exit_trailing_contract_active_binance_be_pct ?? "N/A"} / trail_r=${summary.current_exit_trailing_contract_active_binance_trail_r_multiple ?? "N/A"} / runtime_default=${summary.current_server_signal_runtime_tp1_ladder_default_profile || "N/A"} / diverged=${summary.current_runtime_vs_canonical_exit_contract_diverged ? "YES" : "NO"}`,
    `- server_signal_flow_24h: entry->intent=${summary.current_server_signal_entry_to_intent_conversion_24h != null ? summary.current_server_signal_entry_to_intent_conversion_24h : "N/A"} / signal->fill=${summary.current_server_signal_entry_to_fill_conversion_24h != null ? summary.current_server_signal_entry_to_fill_conversion_24h : "N/A"} / intent->fill=${summary.current_server_signal_intent_to_fill_conversion_24h != null ? summary.current_server_signal_intent_to_fill_conversion_24h : "N/A"}`,
    `- cost_controls: overlap=${summary.current_server_signal_runtime_signal_overlap_enabled ? "ON" : "OFF"}:${summary.current_server_signal_runtime_signal_overlap_bars ?? "N/A"} / same_dir_trail_cd=${summary.current_server_signal_runtime_same_direction_trail_profit_cooldown_enabled ? "ON" : "OFF"}:${summary.current_server_signal_runtime_same_direction_trail_profit_cooldown_ms ?? "N/A"} / reverse=${summary.current_server_signal_runtime_opposite_transition_enabled ? "ON" : "OFF"}:${summary.current_server_signal_runtime_opposite_transition_reduce_fraction ?? "N/A"}:${summary.current_server_signal_runtime_opposite_transition_confirm_bars ?? "N/A"} / watch=${Array.isArray(summary.current_server_signal_runtime_operational_drop_watch_reasons) && summary.current_server_signal_runtime_operational_drop_watch_reasons.length ? summary.current_server_signal_runtime_operational_drop_watch_reasons.join("|") : "N/A"}`,
    ...
    `- performance_kpi_upgrade: ${summary.current_performance_kpi_upgrade_contract_status || "N/A"} / mode=${summary.current_performance_kpi_upgrade_contract_mode || "N/A"} / primary=${Array.isArray(summary.current_performance_primary_metrics) && summary.current_performance_primary_metrics.length ? summary.current_performance_primary_metrics.join("|") : "N/A"} / micro=${summary.current_performance_kpi_upgrade_microstructure_kpi_ready ? "YES" : "NO"} / survivability=${summary.current_performance_kpi_upgrade_survivability_kpi_ready ? "YES" : "NO"} / expectancy=${summary.current_performance_kpi_upgrade_expectancy_kpi_ready ? "YES" : "NO"} / structure=${summary.current_performance_kpi_upgrade_structure_alignment_ready ? "YES" : "NO"} / cost=${summary.current_performance_kpi_upgrade_cost_alignment_ready ? "YES" : "NO"} / tp0=${summary.current_performance_kpi_upgrade_tp0_hit_rate ?? "N/A"} / tp1=${summary.current_performance_kpi_upgrade_tp1_hit_rate ?? "N/A"} / conversion=${summary.current_performance_kpi_upgrade_tp0_to_tp1_conversion_rate ?? "N/A"} / expectancy_net=${summary.current_performance_kpi_upgrade_fee_adjusted_expectancy ?? "N/A"} / legacy_win_ref=${summary.current_performance_kpi_upgrade_legacy_win_rate_reference ?? "N/A"} / block_n=${summary.current_performance_kpi_upgrade_blocking_reason_n ?? "N/A"}`,
