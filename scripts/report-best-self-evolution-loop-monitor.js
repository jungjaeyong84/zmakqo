...
const INPUTS = Object.freeze({
  ...
  serverPrimaryLearningEpoch: path.join(OPS_DAILY_DIR, "best_self_evolution_server_primary_learning_epoch_latest.json"),
...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- server_primary_learning_epoch: ${summary.server_primary_learning_epoch_status || "N/A"} / age_days: ${summary.server_primary_learning_epoch_age_days != null ? summary.server_primary_learning_epoch_age_days : "N/A"} / penalty_weight: ${summary.server_primary_learning_epoch_penalty_weight != null ? summary.server_primary_learning_epoch_penalty_weight : "N/A"}`,
    ...
    `- change_result_attribution: ${summary.change_result_attribution_status || "N/A"} / tracked: ${summary.change_result_attribution_tracked_change_n ?? 0} / 24h: ${summary.change_result_attribution_evaluated_24h_n ?? 0} / 72h: ${summary.change_result_attribution_evaluated_72h_n ?? 0} / top+: ${summary.change_result_attribution_top_positive_stage || "N/A"} / top-: ${summary.change_result_attribution_top_adverse_stage || "N/A"}`,
