...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- FEBT active eligible ${pct(summary.febt_coverage_rate_active_eligible)} (${summary.febt_active_eligible_n || 0}) / by_family: ${renderCoverageLine(summary.febt_active_eligible_by_family)} / by_market: ${renderCoverageLine(summary.febt_active_eligible_by_market)}`,
