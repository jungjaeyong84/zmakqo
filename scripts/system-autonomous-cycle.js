...
function main() {
  ...
  const tasks = [
    ...
    { id: "trail_runner_floor_live_separation", label: "트레일 floor live/historical 분리", bin: "node", args: ["scripts/report-trail-runner-floor-live-separation.js"] },
    ...
    { id: "binance_exit_qty_live_separation", label: "Binance exit 수량 live/historical 분리", bin: "node", args: ["scripts/report-binance-exit-qty-live-separation.js"] },
    { id: "regime_lineage_gap", label: "Regime lineage gap", bin: "node", args: ["scripts/report-regime-lineage-gap.js"] },
