...
function buildStepPlan(context = {}, capabilityDefs = null) {
  const steps = [
    ...
    { id: "lineage_slo_drop_monitor", script: "report-lineage-slo-drop-monitor.js" },
    { id: "ev_probability_calibration", script: "report-best-self-evolution-ev-probability-calibration.js" },
    { id: "ev_gate_composite_policy", script: "report-best-self-evolution-ev-gate-composite-policy.js" },
    ...
    { id: "execution_structure_upgrade_contract", script: "report-best-self-evolution-execution-structure-upgrade-contract.js" },
    { id: "cost_control_engine_contract", script: "report-best-self-evolution-cost-control-engine-contract.js" },
    ...
    { id: "cohort_regime_parameter_split_contract", script: "report-best-self-evolution-cohort-regime-parameter-split-contract.js" },
    ...
    { id: "event_truth_alpha_validation", script: "report-best-self-evolution-event-truth-alpha-validation.js" },
    { id: "failure_learning_loop", script: "report-best-self-evolution-failure-learning-loop.js" },
    { id: "fee_pnl_kpi_authority", script: "report-best-self-evolution-fee-pnl-kpi-authority.js" },
    ...
    { id: "ml_ev_replay_delta_diagnostics", script: "report-best-self-evolution-ml-ev-replay-delta-diagnostics.js" },
    { id: "ml_ev_replay_market_contribution", script: "report-best-self-evolution-ml-ev-replay-market-contribution.js" },
    { id: "ml_ev_replay_profile_contribution", script: "report-best-self-evolution-ml-ev-replay-profile-contribution.js" },
    { id: "ml_ev_replay_stale_pos_diagnostics", script: "report-best-self-evolution-ml-ev-replay-stale-pos-diagnostics.js" },
    { id: "ml_ev_profile_review_tracking", script: "report-best-self-evolution-ml-ev-profile-review-tracking.js" },
    ...
    { id: "validation_deployment_pipeline_contract", script: "report-best-self-evolution-validation-deployment-pipeline-contract.js" },
    { id: "performance_kpi_upgrade_contract", script: "report-best-self-evolution-performance-kpi-upgrade-contract.js" },
