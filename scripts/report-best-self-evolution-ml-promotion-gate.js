...
function renderMarkdown(report = {}) {
  ...
  return [
    ...
    `- global_canary_gate: ${summary.global_canary_gate_status || "N/A"} / evidence=${summary.global_canary_evidence_status || "N/A"} / blocker=${summary.global_canary_dominant_blocker || "N/A"}`,
