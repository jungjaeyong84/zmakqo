...
function renderMarkdown(report = {}) {
  ...
  return [
    ...
    `- best_candidate_id: ${summary.best_candidate_id || "N/A"} / display=${summary.best_display_candidate_id || "N/A"} / canonical=${summary.best_canonical_candidate_id || "N/A"}`,
    `- best_candidate_review: ${summary.best_candidate_review_mode || "N/A"} / targets=${summary.best_candidate_profile_target_n ?? "N/A"} / drag=${summary.best_candidate_top_return_drag_profile || "N/A"}:${summary.best_candidate_top_return_drag_driver || "N/A"} / mixed=${summary.best_candidate_top_mixed_profile || "N/A"}:${summary.best_candidate_top_mixed_driver || "N/A"}`,
