...
function renderMarkdown(report = {}) {
  ...
  return [
    ...
    `- truth_preservation: ${summary.truth_preservation_audit_status || "N/A"} / ready=${summary.truth_preservation_ready ? "YES" : "NO"} / blocks=${summary.truth_preservation_blocking_reason_n != null ? summary.truth_preservation_blocking_reason_n : "N/A"} / warnings=${summary.truth_preservation_warning_reason_n != null ? summary.truth_preservation_warning_reason_n : "N/A"}`,
    `- execution_serving: ${summary.execution_serving_contract_status || "N/A"} / ${summary.execution_serving_stage || "N/A"} / shadow_ready=${summary.execution_serving_shadow_ready ? "YES" : "NO"}`,
    `- ml_promotion_gate: ${summary.ml_promotion_gate_status || "N/A"} / ${summary.ml_promotion_stage || "N/A"} / ${summary.ml_promotion_decision || "N/A"}`,
