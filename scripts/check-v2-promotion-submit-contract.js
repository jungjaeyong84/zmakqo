  ...
  const checks = [
    ...
    buildCheck({
      ...
      ok: packageJsonText.includes("check:v2-live-evidence-readiness")
        ...
        && runbookCheckerText.includes("liveEvidenceReadiness")
        && runbookCheckerText.includes("hasLiveEvidenceReadinessPlan")
        && runbookCheckerText.includes("CHK_13G")
        && runbookCheckerText.includes("V2_LIVE_EVIDENCE_READY")
        && runbookCheckerText.includes("v2_live_evidence_readiness_latest.json")
        ...
        && readText(path.resolve(__dirname, "..", "src", "tests", "check-v2-canary-runbook.test.js")).includes("runbookCheckFailsLiveModeWithoutLiveEvidenceReadinessSummary")
