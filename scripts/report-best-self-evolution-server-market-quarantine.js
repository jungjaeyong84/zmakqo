...
function renderMarkdown(report = {}) {
  ...
  const lines = [
    ...
    `- count_scope: ${summary.count_scope || "N/A"}`,
    `- quarantine_market_n: ${summary.quarantine_market_n ?? "N/A"}`,
    `- watch_only_review_market_n: ${summary.watch_only_review_market_n ?? "N/A"}`,
    `- other_server_policy_watch_only_market_n: ${summary.other_server_policy_watch_only_market_n ?? "N/A"}`,
