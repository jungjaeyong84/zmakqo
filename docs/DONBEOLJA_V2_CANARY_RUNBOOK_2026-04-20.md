...
1A. `promotion-cloudbuild-context.json.artifact_dir` 와 `resolved_artifact_dir` 가 현재 최종 artifact dir와 같고, context/deploy/preflight/manifest cycle id가 모두 같은가
    submit trace-back: `SUBMIT_CHK_01A`
