...
3. 실제 주문 크기가 없는 반사실은 `고정 1000 quote 노출 기준 proxy PnL`로 환산해 마켓 간 비교에 쓴다.
4. 판단 기준은 `드롭 규칙 유지`가 아니라 `일간/주간/월간 목표 달성에 도움이 되는가`다.
5. 서버-파인 parity와 별개로, 드롭 검증은 독립적인 운영 판단 축이다.
